...
public class Display {
	// Colors used for grids
	private static final int EMPTY_COLOR = 0xFFFFFFFF;

	// Color for objects with with no particularly assigned colour
	private static final int UNKNOWN_COLOR = 0x76666666;
	...
	public void gameInitialization(Snake game) {
		int[][] grid = game.getGrid();
		if (grid == null) {
			System.out.println(
					"Your 2d int array grid is null!  Create it by saying grid = new int[___][___] inside your constructor!");
		}
